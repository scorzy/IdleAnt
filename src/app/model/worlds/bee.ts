...
export class Bee implements WorldInterface {
  ...
  initStuff() {
    ...
    this.foragingBee.actions.push(new UpAction(this.game,
      ...
      this.foragingBee, [new Cost(this.game.baseWorld.science, this.game.scienceCost1, this.game.upgradeScienceExp)]))
    ...
    this.workerBee.actions.push(new UpAction(this.game,
      this.workerBee, [new Cost(this.game.baseWorld.science, this.game.scienceCost2, this.game.upgradeScienceExp)]))
    ...
    this.hiveBee.actions.push(new BuyAction(this.game,
      ...
      [
        ...
        new Cost(this.game.baseWorld.honey, Decimal(1E6), this.game.buyExp),
